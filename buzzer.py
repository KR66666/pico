...
# Vánoční píseň - Tichá noc (Silent Night)
song = [
    "G4", "G4", "A4", "G4", "C4", "D4", "E4",  # "Tichá"
    "F4", "F4", "F4", "E4", "E4", "D4", "C4",  # "noc,"
    "G4", "G4", "A4", "G4", "C4", "D4", "E4",  # "svatá,"
    "F4", "F4", "F4", "E4", "E4", "D4", "C4",  # "noc."
    
    "G4", "G4", "A4", "G4", "C4", "D4", "E4",  # "Tichá"
    "F4", "F4", "F4", "E4", "E4", "D4", "C4",  # "noc,"
    
    "G4", "G4", "A4", "G4", "C4", "D4", "E4",  # "Světlá"
    "F4", "F4", "F4", "E4", "E4", "D4", "C4",  # "noc,"
    
    "G4", "G4", "A4", "G4", "C4", "D4", "E4",  # "Všem"
    "F4", "F4", "F4", "E4", "E4", "D4", "C4"   # "lidem"
]
...
# Funkce pro ztišení zvuku
def bequiet():
    buzzer.duty_u16(0)

# Funkce pro přehrání písničky
def playsong(mysong):
    for note in mysong:
        if note == "P":
            bequiet()
            ...
            playtone(tones[note])
        sleep(0.5)  # Pauza mezi notami (můžete změnit podle potřeby)
    bequiet()

# Přehrání vánoční písně
playsong(song)
